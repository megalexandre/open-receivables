...
import 'package:organizagrana/features/categories/presentation/widgets/category_form_dialog.dart';
...
class _CategoriesPageState extends State<CategoriesPage> {
  ...
  Future<void> _openForm([Category? category]) async {
    final result = await CategoryFormDialog.show(context, category);
